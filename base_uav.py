...
class BaseUAV(object): # parent
    def __init__(self, uav_id, ip, port, uav_number):
        ...
        self.initialize(int(self.uav_id), ip, port, uav_number)
    ...
    def uav_msg_callback(self, uav_msg): 
        ...
        self.act(self.uav_msg, formation) # Son True Hazirlik anlamina geliyor
