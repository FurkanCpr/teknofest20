...
# begin: testing
def test_callback0(data):
    print("test_callback0 data:" + data)


def test_callback1(data):
    print("test_callback1 data:" + data)


def test_consumer_producer():
    rabbit_comm = RabbitCommunication()
    if sys.argv[1] == 'listen':
        rabbit_comm.register_to_queue(sys.argv[2], test_callback0)
        rabbit_comm.register_to_queue(sys.argv[3], test_callback1)
...
def test_consumer_producer_with_threads():
    if sys.argv[1] == 'team':
...
if __name__ == "__main__":
    ...
    test_consumer_producer_with_threads()
